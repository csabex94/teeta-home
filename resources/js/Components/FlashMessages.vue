<template>
  <div>
    <div v-if="$page.props.flash.success && show" class="mt-24 w-full flex items-center mx-auto justify-between bg-green-500 rounded max-w-3xl">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="mt-24 mx-auto flex items-center justify-between bg-red-400 rounded max-w-3xl">
      <div class="flex items-center">
