        ...
        <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                <div class="flex items-center justify-center pt-6">
                    ...
                    <h1 class="text-2xl font-bold text-gray-700">Teeta</h1>
                </div>
                <nav class="mt-6">
                    <div>
                        <inertia-link :href="route('light')" class="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 dark:from-gray-700 dark:to-gray-800">
                        ...
                        <div class="container relative left-0 z-50 flex w-3/4 h-auto">
                            ...
                            <div class="relative p-1 flex items-center justify-end w-1/4 ml-5 mr-4 sm:mr-0 sm:right-auto">
                                <div class="mr-5 relative p-2 shadow-lg rounded-full cursor-pointer text-blue-600">
                                    ...
                                    <span class="absolute bg-red-500 px-1 text-xs rounded-full top-0 right-2 text-white">3</span>
                                </div>
