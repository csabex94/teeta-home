    ...
    <light-layout>
        <template #content>
            <div class="px-5 max-w-7xl mx-auto">
                <span class="block mb-5 text-xl text-gray-800 text-center">Events</span>
                ...
                <div class="flex items-center mb-5">
                    ...
                    <div class="w-full relative">
                        <flat-pickr
                            ...
                            class="border-gray-300 cursor-pointer w-full focus:border-gray-300 focus:ring focus:ring-gray-400 focus:ring-opacity-50 rounded-md shadow-sm"
                ...
                <div v-for="event in events" :key="event.id" class="mb-3 rounded-lg shadow h-24 bg-white text-gray-700 px-2">
                    ...
                    <div class="flex items-end">
                        <span @click="openEditModal(event)" class="flex flex-col cursor-pointer hover:text-blue-500 items-center mx-5">
                            ...
                            <span @click="openDeleteEventModal(event.id)" class="flex flex-col items-center cursor-pointer hover:text-red-400">
                             <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
