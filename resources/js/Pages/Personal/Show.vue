    ...
    <light-layout>
        <template #content>
            <div class="px-5 max-w-7xl mx-auto">
                <span class="block mb-5 text-xl text-gray-800 text-center">Personal Stuff</span>

                <div v-for="event in items" :key="event.id" class="mb-3 rounded-lg shadow h-24 text-white bg-gray-700 px-2">
                ...
                <jet-dialog-modal :show="showEditModal" @close="closeEditModal">
                    <template #title>Edit Personal Info</template>
