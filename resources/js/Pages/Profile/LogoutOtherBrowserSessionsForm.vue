<template>
    <jet-action-section>
        <template #title>
            <span class="text-gray-200">Browser Sessions</span>
        </template>

        <template #description>
            <span class="text-gray-200">Manage and log out your active sessions on other browsers and devices.</span>
        </template>
        ...
        <template #content>
            ...
            <div class="mt-5 space-y-6" v-if="sessions.length > 0">
                <div class="flex items-center" v-for="(session, i) in sessions" :key="i">
                    <div>
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="w-8 h-8 text-gray-200" v-if="session.agent.is_desktop">
