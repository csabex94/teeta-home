<template>
    <div class="h-full">
        <div class="bg-white fixed w-1/6 h-full rounded-2xl dark:bg-gray-700">
            ...
            <nav class="mt-6">
                <div>
                    <jet-sidebar-link :href="route('dashboard')" :active="route().current('dashboard')">
                    ...
                    <jet-sidebar-link :href="route('personal.show')" :active="route().current('personal.show')">
                            <span class="text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <jet-sidebar-link :href="route('friends.show')" :active="route().current('friends.show')">
                            <span class="text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
