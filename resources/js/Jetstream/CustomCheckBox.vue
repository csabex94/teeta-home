<template>
    <div>
        <svg v-if="!checked && status !== 'completed'" width="20" height="20" fill="currentColor" class="cursor-pointer mx-4 text-gray-400 dark:text-gray-300" viewBox="0 0 1024 1024">
        ...
        <svg v-else width="20" height="20" fill="currentColor" viewBox="0 0 1024 1024" class="cursor-pointer text-green-500 mx-4">
